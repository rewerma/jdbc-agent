...
public class JdbcStatement implements Statement {
     ...
     * @throws SQLException
     */
    private Serializable invokeStatementMethod(Method method) throws SQLException {
     ...
     * @throws SQLException
     */
    private Serializable invokeStatementMethod(Method method, Serializable[] params)
            throws SQLException {
