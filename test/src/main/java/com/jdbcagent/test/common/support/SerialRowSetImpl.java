package com.jdbcagent.test.common.support;


import com.jdbcagent.test.common.support.internal.*;
 ...
 * during the life-time of any SerialRowSetImpl.
 *
 * @author Jonathan Bruce, Amit Handa
 */

public class SerialRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
...
//    private SyncProvider provider;
     ...
     * <code>SerialRowSetImpl</code> object's current underlying data source.
     */
     ...
     * current source of data for this <code>SerialRowSetImpl</code> object.
     */
    private transient ResultSetMetaData RSMD;

    /**
     * The <code>RowSetMetaData</code> object that contains information about
     * the columns in this <code>SerialRowSetImpl</code> object.
     *
     * @serial
     */
    private SerialRowSetMetaDataImpl RowSetMD;

    // Properties of this RowSet

    /**
     * An array containing the columns in this <code>SerialRowSetImpl</code>
    ...
    /**
     * A <code>ArrayList</code> object containing the <code>Row</code>
     * objects that comprise  this <code>SerialRowSetImpl</code> object.
     *
     * @serial
     */
    private ArrayList<Object> rvh;

    /**
     * The current postion of the cursor in this <code>SerialRowSetImpl</code>
     * object.
     *
     * @serial
     */
    ...
    /**
     * The number of deleted rows currently in this <code>SerialRowSetImpl</code>
     * object.
     *
     * @serial
     */
    ...
    /**
     * The total number of rows currently in this <code>SerialRowSetImpl</code>
     * object.
     *
     * @serial
     */
     ...
     */
    private transient SQLWarning sqlwarn;
     ...
     */
    private transient RowSetWarning rowsetWarning;

    /**
     * The default SyncProvider for the RI SerialRowSetImpl
     */
//    private String DEFAULT_SYNC_PROVIDER = "com.sun.rowset.providers.RIOptimisticProvider";
     ...
     */
    private SerialRowSetReader crsReader;

    /**
     * The ArrayList holding the Match Columns
     */
    private ArrayList<Integer> iMatchColumns;

    /**
     * The ArrayList that will hold the Match Column names.
     */
    private ArrayList<String> strMatchColumns;
    ...
    /**
     * Constructs a new default <code>SerialRowSetImpl</code> object with
     ...
     *     numRows = 0
     * </pre>
     * A <code>SerialRowSetImpl</code> object is configured to use the default
     ...
     */
    public SerialRowSetImpl() throws SQLException {
...
//        }
        ...
        rowSetReader = new SerialRowSetReader(); //(CachedRowSetReader)provider.getRowSetReader();
        rowSetWriter = new SerialRowSetWriter(); //(CachedRowSetWriter)provider.getRowSetWriter();
    ...
    public SerialRowSetImpl(ResultSet resultSet) throws SQLException {
        this();
        this.resultSet = resultSet;
    }

    /**
     * Provides a <code>SerialRowSetImpl</code> instance with the same default properties as
     ...
     * <p>
     * For example, creating a <code>SerialRowSetImpl</code> object as follows ensures
     ...
     *     SerialRowSetImpl crs = new CachedRowSet(env);
     * </pre>
     * <p>
    ...
    public SerialRowSetImpl(Hashtable env) throws SQLException {
...
//                (SyncProvider)SyncFactory.getInstance(providerName);
        ...
        rowSetReader = new SerialRowSetReader(); //provider.getRowSetReader();
        rowSetWriter = new SerialRowSetWriter(); //provider.getRowSetWriter();
    ...
    private void initContainer() {
        ...
        rvh = new ArrayList<Object>(100); //new Vector<Object>(100);
        cursorPos = 0;
        absolutePos = 0;
        numRows = 0;
        numDeleted = 0;
    ...
    /**
     * Sets the properties for this <code>SerialRowSetImpl</code> object to
    ...
    private void initProperties() throws SQLException {
        ...
        iMatchColumns = new ArrayList<Integer>(10); //new Vector<Integer>(10);
        for (int i = 0; i < 10; i++) {
            iMatchColumns.add(i, Integer.valueOf(-1));
        }

        strMatchColumns = new ArrayList<String>(10); //new Vector<String>(10);
        for (int j = 0; j < 10; j++) {
    ...
    private void establishTransactionalWriter() {
        tWriter = (TransactionalWriter) this.rowSetWriter; //provider.getRowSetWriter();
    }
    ...
    /**
     * Sets this <code>SerialRowSetImpl</code> object's command property
    ...
    /**
     * Populates this <code>SerialRowSetImpl</code> object with data from
     ...
     * <code>SerialRowSetImpl</code> object's command.
     * <p>
     ...
     *             to be read into this <code>SerialRowSetImpl</code> object
...
//
//        // set up the metadata
//        RowSetMD = new SerialRowSetMetaDataImpl();
...
//        notifyRowSetChanged();
     ...
     * @author Machengyuan
     */
    public void populateRSMD() throws SQLException {
        // get the meta data for this ResultSet
        if (RowSetMD == null) {
     ...
     * @author Machengyuan
     */
    public void populate(int size) throws SQLException {
        int rowsFetched;
        Row currentRow;
        int numCols;
        int i;
     ...
     *             <code>SerialRowSetImpl</code> object, which will be set with
     *             values from rsmd
     * @param rsmd the <code>ResultSetMetaData</code> object from which new
     *             values for md will be read
     * @throws SQLException if an error occurs
     */
    private void initMetaData(SerialRowSetMetaDataImpl md, ResultSetMetaData rsmd) throws SQLException {
    ...
    /**
     * Populates this <code>SerialRowSetImpl</code> object with data,
    ...
    public void execute(Connection conn) throws SQLException {
        ...
        if (getPageSize() != 0) {
            crsReader = (SerialRowSetReader) this.rowSetReader; //provider.getRowSetReader();
        ...
        RowSetMD = (SerialRowSetMetaDataImpl) this.getMetaData();
    ...
    /**
     * Sets this <code>SerialRowSetImpl</code> object's connection property
     ...
     * <code>SerialRowSetImpl</code> object can retrieve the connection stored
     ...
     *                   in this <code>SerialRowSetImpl</code> object's connection
     *                   property
     */
     ...
     * underlying data source backing this <code>SerialRowSetImpl</code>
     * object.
     * <p>
        ...
        try {
            ...
            if ((tXWriter) && this.COMMIT_ON_ACCEPT_CHANGES) {
                ...
                if (!conflict) {
                    ...
                    tWriter = (TransactionalWriter) rowSetWriter;
                    if (tWriter instanceof SerialRowSetWriter) {
                        ((SerialRowSetWriter) tWriter).commit(this, updateOnInsert);
                    } else {
                        tWriter.commit();
                    }
    ...
    /**
     * Propagates all row update, insert, and delete changes to the
     * data source backing this <code>SerialRowSetImpl</code> object
    ...
    /**
     * Restores this <code>SerialRowSetImpl</code> object to its original state,
    ...
    /**
     * Releases the current contents of this <code>SerialRowSetImpl</code>
     ...
     * <code>SerialRowSetImpl</code> object if the row has been inserted, and
     ...
     * that of this <code>SerialRowSetImpl</code> object and sharing a set of cursors
     * with it. This allows cursors to interate over a shared set of rows, providing
     * multiple views of the underlying data.
     *
     * @return a <code>RowSet</code> object that is a copy of this <code>SerialRowSetImpl</code>
     ...
     * as this <code>SerialRowSetImpl</code> object.  This method
     ...
     *
     * @return a copy of this <code>SerialRowSetImpl</code> object
     * @throws CloneNotSupportedException if an error occurs when
     *                                    attempting to clone this <code>SerialRowSetImpl</code> object
     * @see #createShared
     */
     ...
     * this <code>SerialRowSetImpl</code> object's data, including
     ...
     * completely independent from this <code>SerialRowSetImpl</code>
     * object.
     * @throws SQLException if an error occurs in generating the copy of this
     *                      of the <code>SerialRowSetImpl</code>
     * @see #createShared
     * @see RowSetEvent
     * @see RowSetListener
     */
    public CachedRowSet createCopy() throws SQLException {
        ...
        try {
            ...
            SerialRowSetImpl crsTemp = (SerialRowSetImpl) in.readObject();
     ...
     * this <code>SerialRowSetImpl</code> object's table structure
     ...
     * of this <code>SerialRowSetImpl</code> object's schema and
     ...
     * this <code>SerialRowSetImpl</code> object's data only.
     * All constraints set in this object will not be there
     * in the returning object.  Updates made
     * on a copy are not visible to the original rowset.
     *
     * @return a new <code>CachedRowSet</code> object that is a deep copy
     * of this <code>SerialRowSetImpl</code> object and is
     * completely independent from this <code>SerialRowSetImpl</code> object
    ...
    public CachedRowSet createCopyNoConstraints() throws SQLException {
        ...
        SerialRowSetImpl crs;
        crs = (SerialRowSetImpl) this.createCopy();
    ...
    /**
     * Converts this <code>SerialRowSetImpl</code> object to a collection
     ...
     * <code>SerialRowSetImpl</code> object
    ...
    /**
     * Returns the specified column of this <code>SerialRowSetImpl</code> object
    ...
    public Collection<?> toCollection(int column) throws SQLException {
        ...
        ArrayList<Object> vec = new ArrayList<>(nRows);

        // create a copy
        SerialRowSetImpl crsTemp;
        crsTemp = (SerialRowSetImpl) this.createCopy();
     ...
     * with this <code>SerialRowSetImpl</code> implementation rowset.
     *
...
//        rowSetWriter = provider.getRowSetWriter();
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the next
    ...
    /**
     * Closes this <code>SerialRowSetImpl</code> objecy and releases any resources
     * it was using.
     *
     * @throws SQLException if an error occurs when releasing any resources in use
     *                      by this <code>SerialRowSetImpl</code> object
     */
     ...
     * in this <code>SerialRowSetImpl</code> object and throws
     ...
     *
     * @param idx the number of a column in this <code>SerialRowSetImpl</code>
    ...
    /**
     * Checks to see whether the cursor for this <code>SerialRowSetImpl</code>
     ...
     *
     * @throws SQLException if the cursor for this <code>SerialRowSetImpl</code>
     ...
     * <code>SerialRowSetImpl</code> object.  This method throws an
     ...
     *             this <code>SerialRowSetImpl</code> object
     ...
     * <code>SerialRowSetImpl</code>object.
     *
     * @return the <code>Row</code> object on which this <code>SerialRowSetImpl</code>
     ...
     * of this <code>SerialRowSetImpl</code> object as a
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>SerialRowSetImpl</code> object as an
     * <code>int</code> value.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *                    is <code>2</code>, and so on; must be <code>1</code> or larger
     ...
     * <code>SerialRowSetImpl</code> object as a <code>java.io.InputStream</code>
     * object.
     * <p>
     ...
     * stream may return <code>0</code> for <code>SerialRowSetImpl.available()</code>
    ...
    public InputStream getAsciiStream(int columnIndex) throws SQLException {
        ...
        return (InputStream) asciiStream;
    }
    ...
    public InputStream getUnicodeStream(int columnIndex) throws SQLException {
        ...
        return (InputStream) unicodeStream;
    }
     ...
     * <code>SerialRowSetImpl.available()</code> whether there is data
     * available or not.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *                    is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    public InputStream getBinaryStream(int columnIndex) throws SQLException {
        ...
        return (InputStream) binaryStream;
     ...
     *                   a column in this <code>SerialRowSetImpl</code> object
    ...
    /**
     * Retrieves the value stored in the designated column
     * of the current row of this <code>SerialRowSetImpl</code> object
    ...
    /**
     * The first warning reported by calls on this <code>SerialRowSetImpl</code>
     * object is returned. Subsequent <code>SerialRowSetImpl</code> warnings will
    ...
    /**
     * Clears all the warnings reporeted for the <code>SerialRowSetImpl</code>
     ...
     *
     * @return the SQL cursor name for this <code>SerialRowSetImpl</code> object's
     * cursor
     * @throws SQLException if an error occurs
     */
     ...
     * <code>SerialRowSetMetaDataImpl</code> class.
     * <p>
     * For example:
     * <pre>
     * CachedRowSet crs = new SerialRowSetImpl();
     * SerialRowSetMetaDataImpl metaData =
     *     (SerialRowSetMetaDataImpl)crs.getMetaData();
     * // Set the number of columns in the RowSet object for
     * // which this SerialRowSetMetaDataImpl object was created to the
     * // given number.
     ...
     * <code>SerialRowSetImpl</code> object's columns
     * @throws SQLException if an error occurs in generating the RowSet
     *                      meta data; or if the <code>SerialRowSetImpl</code> is empty.
     * @see RowSetMetaData
     */
    ...
    /**
     * Maps the given column name for one of this <code>SerialRowSetImpl</code>
    ...
    /**
     * Returns the number of rows in this <code>SerialRowSetImpl</code> object.
     *
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the front of
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the end of
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the first row
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the first
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the last row
     * and returns <code>true</code> if the operation was successful.  This
     * method also notifies registered listeners that the cursor has moved.
     *
     * @return <code>true</code> if the cursor is on a valid row;
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the last
     * row and returns <code>true</code> if the operation is successful.
     * <p>
    ...
    /**
     * Returns the number of the current row in this <code>SerialRowSetImpl</code>
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the row number
     * specified.
     *
     ...
     * <code>crs</code> is a <code>SerialRowSetImpl</code> object, moves the cursor
     ...
     * If the <code>SerialRowSetImpl</code> object <code>crs</code> has five rows,
     ...
     * <code>crs</code> is a <code>SerialRowSetImpl</code> object with 100 rows,
     ...
     * <code>SerialRowSetImpl</code> object; <code>false</code>
     * otherwise
    ...
    /**
     * Moves this <code>SerialRowSetImpl</code> object's cursor to the
     ...
     * <code>SerialRowSetImpl</code> object that its cursor has moved.
     * <p>
     ...
     * the <code>SerialRowSetImpl</code> object <code>crs</code>, which has
    ...
    /**
     * Moves the cursor to the previous row in this <code>SerialRowSetImpl</code>
    ...
    /**
     * Indicates whether the current row of this <code>SerialRowSetImpl</code>
     ...
     * this <code>SerialRowSetImpl</code> object has been updated. The
     ...
     * insert row of this <code>SerialRowSetImpl</code> object with
     ...
     * row of this <code>SerialRowSetImpl</code> object with the given
     * <code>boolean</code> value.
     * <p>
     * This method updates a column value in the current row or the insert
    ...
    /**
     * Inserts the contents of this <code>SerialRowSetImpl</code> object's insert
    ...
    /**
     * Marks the current row of this <code>SerialRowSetImpl</code> object as
    ...
    /**
     * Deletes the current row from this <code>SerialRowSetImpl</code> object and
     ...
     * <code>SerialRowSetImpl</code> object and notifies listeners that
    ...
    /**
     * Moves the cursor for this <code>SerialRowSetImpl</code> object
     ...
     * undetermined.
     *
     * @throws SQLException if this <code>SerialRowSetImpl</code> object is
     *                      <code>ResultSet.CONCUR_READ_ONLY</code>
     */
    ...
    /**
     * Moves the cursor for this <code>SerialRowSetImpl</code> object to
     ...
     * <code>SerialRowSetImpl</code> object as an <code>Object</code> in
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>SerialRowSetImpl</code> object as a <code>Ref</code> object
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>SerialRowSetImpl</code> object as a <code>Blob</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *                    is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>SerialRowSetImpl</code> object as a <code>Clob</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *                    is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>SerialRowSetImpl</code> object as an <code>Array</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     *                    is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>SerialRowSetImpl</code> object as a <code>java.sql.Date</code>
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>SerialRowSetImpl</code> object as a <code>java.sql.Time</code>
     * object, using the given <code>Calendar</code> object to construct an
     * appropriate millisecond value for the date.
     *
     * @param columnIndex the first column is <code>1</code>, the second
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>SerialRowSetImpl</code> object as a <code>java.sql.Timestamp</code>
     * object, using the given <code>Calendar</code> object to construct an
     * appropriate millisecond value for the date.
     *
     * @param columnIndex the first column is <code>1</code>, the second
     ...
     * <code>SerialRowSetImpl</code> object.  This connection may be
    ...
    /**
     * Sets the metadata for this <code>SerialRowSetImpl</code> object
    ...
    public void setMetaData(RowSetMetaData md) throws SQLException {
        RowSetMD = (SerialRowSetMetaDataImpl) md;
    }

    /**
     * Returns a result set containing the original value of the rowset. The
     * original value is the state of the <code>SerialRowSetImpl</code> after the
    ...
    public ResultSet getOriginal() throws SQLException {
        SerialRowSetImpl crs = new SerialRowSetImpl();
     ...
     * row only.
     * The original value is the state of the <code>SerialRowSetImpl</code> after
     ...
     * which this <code>SerialRowSetImpl</code> object was derived
     * @throws SQLException if an error occurs
     */
     ...
     *                table from which this <code>SerialRowSetImpl</code> object
     *                was derived
     * @throws SQLException if an error occurs
     */
     ...
     * row in this <code>SerialRowSetImpl</code> object.
     *
    ...
    /**
     * Sets this <code>SerialRowSetImpl</code> object's
     ...
     *             <code>SerialRowSetImpl</code> object; every
    ...
    /**
     * Retrieves the value of the designated column in this
     * <code>SerialRowSetImpl</code> object as a <code>java.net.URL</code> object
     * in the Java programming language.
     *
...
//        strMatchColumns.copyInto(str_temp);
        String[] str_temp = strMatchColumns.toArray(new String[0]);
        return str_temp;
    }
...
//        iMatchColumns.copyInto(int_temp);
        Integer[] int_temp = iMatchColumns.toArray(new Integer[0]);
...
//        }
//        if (pageSize == 0) {
//            rvh = new ArrayList<Object>(getMaxRows()); //new Vector<Object>(getMaxRows());
//
//        } else {
//            rvh = new ArrayList<Object>(getPageSize()); //new Vector<Object>(getPageSize());
//        }
//
//        if (data == null) {
//            throw new SQLException(resBundle.handleGetObject("cachedrowsetimpl.populate").toString());
...
//        notifyRowSetChanged();
    ...
    /**
     * The nextPage gets the next page, that is a <code>SerialRowSetImpl</code> object
...
//////////////////////////
    ...
    private static final long serialVersionUID = -2327798814293027285L;
}