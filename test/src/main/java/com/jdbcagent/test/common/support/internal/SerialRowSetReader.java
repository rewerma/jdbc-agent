 ...
 */
public class SerialRowSetReader implements RowSetReader, Serializable {
    /**
                ...
                if (param.length == 2) {
                    ...
                    if (param[0] instanceof java.io.InputStream) {
                        switch (((Integer) param[2]).intValue()) {
                            case SerialRowSetImpl.UNICODE_STREAM_PARAM:
                                pstmt.setUnicodeStream(i + 1,
                                        (java.io.InputStream) param[0],
                                        ((Integer) param[1]).intValue());
                            case SerialRowSetImpl.BINARY_STREAM_PARAM:
                                pstmt.setBinaryStream(i + 1,
                                        (java.io.InputStream) param[0],
                                        ((Integer) param[1]).intValue());
                            case SerialRowSetImpl.ASCII_STREAM_PARAM:
    ...
    private static final long serialVersionUID = -5219514448897423496L;
}
