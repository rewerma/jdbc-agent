 ...
 * questions.
 */
package com.jdbcagent.test.common.support.internal;


import com.jdbcagent.test.common.support.JdbcRowSetResourceBundle;
 ...
 */
public class SyncResolverImpl extends SerialRowSetImpl implements SyncResolver {
    /**
     ...
     * from getStatus()
     */
    private SerialRowSetImpl crsRes;
     ...
     * datasource.
     */
    private SerialRowSetImpl crsSync;
     ...
     */
    private SerialRowSetWriter crw;
    ...
    public SyncResolverImpl() throws SQLException {
        try {
            crsSync = new SerialRowSetImpl();
            crsRes = new SerialRowSetImpl();
            crw = new SerialRowSetWriter();
            row = new SerialRowSetImpl();
            rowStatus = 1;
            try {
    ...
    public void setResolvedValue(int index, Object obj) throws SQLException {
        ...
        try {
            ...
            if( ((crsSync.getObject(index)).toString()).equals(obj.toString()) ||
                ...
                /**
                 * Step 2: Change the value in the SerialRowSetImpl object
                ...
                if(bool) {
                    /**
                     * sync data back using SerialRowSetWriter
                     * construct the present row and pass it to the writer
                     * to write back to db.
                     **/
                    try {
                        /**
                         * Note : The use of SerialRowSetWriter to get *same* Connection handle.
                         * The SerialRowSetWriter uses the connection handle
                         * from the reader, Hence will use the same connection handle
                         * as of original SerialRowSetImpl
                         **/
    ...
    /**
     * This passes a CachedRowSet as a row the the SerialRowSetWriter
    ...
    private CachedRowSet buildCachedRow() throws SQLException {
        int iColCount;
        SerialRowSetImpl crsRow = new SerialRowSetImpl();
     ...
     **/
    void setCachedRowSetWriter(SerialRowSetWriter CRWriter) {
        crw = CRWriter;
    }
    ...
    private static final long serialVersionUID = 3761872899430668245L;
} //end class
