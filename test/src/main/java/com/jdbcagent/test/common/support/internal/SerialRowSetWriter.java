 ...
 */
public class SerialRowSetWriter implements TransactionalWriter, Serializable {
     ...
     * @serial
     */
    private SerialRowSetReader reader;
     ...
     */
    private SerialRowSetImpl crsResolve;
    ...
    public boolean writeData(RowSetInternal caller) throws SQLException {
        ...
        SerialRowSetImpl crs = (SerialRowSetImpl) caller;
        // crsResolve = new SerialRowSetImpl();
        this.crsResolve = new SerialRowSetImpl();
        ;
...
//                Vector cols = new Vector();
    ...
    private boolean insertNewRow(CachedRowSet crs,
                                 PreparedStatement pstmt, SerialRowSetImpl crsRes) throws SQLException {
        int i = 0;
        int icolCount = crs.getMetaData().getColumnCount();
     ...
     */
    private boolean deleteOriginalRow(CachedRowSet crs, SerialRowSetImpl crsRes) throws SQLException {
        PreparedStatement pstmt;
        int i;
        int idx = 0;
        String strSelect;
     ...
     * @throws SQLException if a database access error occurs
     */
    public void setReader(SerialRowSetReader reader) throws SQLException {
        this.reader = reader;
    }
     ...
     * @throws SQLException if a database access error occurs
     */
    public SerialRowSetReader getReader() throws SQLException {
        return reader;
    }
    ...
    public void commit(SerialRowSetImpl crs, boolean updateRowset) throws SQLException {
        con.commit();
        if (updateRowset) {
    ...
    private static final long serialVersionUID = -2560561552264603759L;
}
