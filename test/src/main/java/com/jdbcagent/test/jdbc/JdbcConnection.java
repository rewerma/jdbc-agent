...
public class JdbcConnection implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        ...
        return new JdbcStatement(stmtKey);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        Integer pstmtKey = (Integer) Connector.connInvoke(remoteKey, "prepareStatement", sql);
        return new JdbcPreparedStatement(pstmtKey);
    }

    @Override
    public JdbcCallableStatement prepareCall(String sql) throws SQLException {
        return new JdbcCallableStatement(null);
    }

    @Override
    public String nativeSQL(String sql) throws SQLException {
        return (String) Connector.connInvoke(remoteKey, "nativeSQL", sql);
    }
    ...
    public void close() throws SQLException {
        Connector.connInvoke(remoteKey, "close");
    }

    @Override
    public boolean isClosed() throws SQLException {
        return (Boolean) Connector.connInvoke(remoteKey, "isClosed");
    }

    @Override
    public DatabaseMetaData getMetaData() throws SQLException {
        return new JdbcDatabaseMetaData(null);
    }
