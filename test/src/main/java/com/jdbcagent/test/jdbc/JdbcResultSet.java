package com.jdbcagent.test.jdbc;

import com.jdbcagent.test.connector.Connector;
...
public class JdbcResultSet implements ResultSet {
    ...
    private int remoteId;                                  // 远程resultSetId
     ...
     * @throws SQLException
     */
    public JdbcResultSet(int remoteId) {
    ...
    private void invokeMetaData() throws SQLException {
        rowSet = (RowSet) Connector.rsInvoke(remoteId, "invokeMetaData");
    }
...
//        }
        clearRowSet();
        rowSet = (RowSet) Connector.rsInvoke(remoteId, "fetchRows", BATCH_SIZE);
    }
    ...
    public void close() throws SQLException {
        Connector.rsInvoke(remoteId, "close");
    }
